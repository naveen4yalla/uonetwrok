App={
    ...
    loadContract: async () => {
        ...
        let mx = "0xb658C8CA21F695BA91BDD798b53982458B05BEc2"
        console.log(App.network,"sdfsad")
        ...
        else if (App.network =="local")App.contracts.dwitter = new web3.eth.Contract(abi, mx);
